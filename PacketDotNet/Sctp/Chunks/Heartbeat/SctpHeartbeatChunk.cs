...
// Type: PacketDotNet.Sctp.Chunks.Heartbeat.SctpHeartbeatChunk
...
{
  public class SctpHeartbeatChunk : SctpChunk
  {
    ...
    public SctpHeartbeatChunk(ByteArraySegment bas)
    {
      this.Header = bas;
    ...
    public SctpHeartbeatChunk(ByteArraySegment bas, Packet parent)
      : this(bas)
    {
