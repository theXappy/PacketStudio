...
namespace PacketStudio.NewGUI.ProtocolFactories
{
    ...
    {
        public TempPacketSaveData GetPacket(byte[] payload, int streamId, byte protocol)
        {
            ...
            IPv4Packet ipPacket = new IPv4Packet(sourceIp, destIp) { Protocol = (ProtocolType)protocol , PayloadData = payload };
